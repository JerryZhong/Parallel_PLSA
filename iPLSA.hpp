...
public:
	...
	iPLSA(const string & matFileName, char* indexMidFileName, char* indexTagFileName, int _testPercentage, int numCats, int numIter, int numRestarts, double betastart, 
